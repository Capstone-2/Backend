...
const sendTokenCookie = (response, user) => response.cookie(COOKIE_NAME, signToken(user), cookieOptions);
...
const requireAuth = async (request, response, next) => {
  ...
  if (bearer) {
    ...
    return jwtCheck(request, response, async (error) => {
...
const identityFromToken = (request) => {
